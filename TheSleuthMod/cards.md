...
| Frightening Beast | ![](small-card-images/FrighteningBeast.png) | ![]() | Curse | Curse |  | Unplayable. Whenever a card Purges, Topdeck this. |
...
| Diplomacy | ![](small-card-images/Diplomacy.png) | ![](small-card-images/DiplomacyPlus.png) | Basic | Attack | 1 | Gain 7(9) Block. Deal 7(9) damage. Exhaust a card in your hand. |
...
| Think Ahead | ![](small-card-images/ThinkAhead.png) | ![](small-card-images/ThinkAheadPlus.png) | Common | Skill | 1(0) | Play the top card of your draw pile. |
| Tootsie Shotgun | ![](small-card-images/TootsieShotgun.png) | ![](small-card-images/TootsieShotgunPlus.png) | Common | Attack | 1 | Deal 5(7) damage twice. Damage is increased by Auto-Parry stacks. |
...
| Candy Leather | ![](small-card-images/CandyLeather.png) | ![](small-card-images/CandyLeatherPlus.png) | Uncommon | Skill | 1 | Gain 5(8) Block. Return an Imagination card from your discard pile to your hand. |
| Club Club | ![](small-card-images/ClubClub.png) | ![](small-card-images/ClubClubPlus.png) | Uncommon | Attack | 1 | Deal 6(8) damage to ALL enemies twice. Lose 1 of your highest stat. |
| Deprogram | ![](small-card-images/Deprogram.png) | ![](small-card-images/DeprogramPlus.png) | Uncommon | Skill | 0 | Look at the top 4 cards of your draw pile. You may discard any of them. Apply 1(2) Vulnerable to ALL enemies. |
| Diamond Armor | ![](small-card-images/DiamondArmor.png) | ![](small-card-images/DiamondArmorPlus.png) | Uncommon | Skill | 1 | Gain 14(17) Block. Discard 1 card. Lose 1 of your highest stat. |
| Distill | ![](small-card-images/Distill.png) | ![](small-card-images/DistillPlus.png) | Uncommon | Skill | 1(0) | Obtain a random potion. Gain 1 Auto-Parry. Purge. |
| Embarrass | ![](small-card-images/Embarrass.png) | ![](small-card-images/EmbarrassPlus.png) | Uncommon | Skill | 1(0) | Apply 3 Weak. Apply 3 Vulnerable. Topdeck 1 Mural. |
...
| Throw Hat | ![](small-card-images/ThrowHat.png) | ![](small-card-images/ThrowHatPlus.png) | Uncommon | Skill | X | Gain 6 Block X (X+1) times. Mill X (X+1). |
| Tommygun/Keyring | ![](small-card-images/TommygunKeyring.png) | ![](small-card-images/TommygunKeyringPlus.png) | Uncommon | Attack | 1 | Deal 6(8) damage twice. / Gain 5(6) Block twice. Switches form at the start of your turn. |
| Torso Flail | ![](small-card-images/TorsoFlail.png) | ![](small-card-images/TorsoFlailPlus.png) | Uncommon | Skill | 1(0) | Play a card in your discard pile and Exhaust it. |
| Treaty | ![](small-card-images/Treaty.png) | ![](small-card-images/TreatyPlus.png) | Uncommon | Skill | 0 | Retain. You and the enemy (ALL enemies) cannot gain buffs for 1 turn. |
| Triple Scuffle | ![](small-card-images/TripleScuffle.png) | ![](small-card-images/TripleScufflePlus.png) | Uncommon | Attack | 1 | Deal 8(10) damage. Draw 2(3) cards. Discard all cards drawn this way with Retain. |
| Truffle Trouble | ![](small-card-images/TruffleTrouble.png) | ![](small-card-images/TruffleTroublePlus.png) | Uncommon | Attack | 5(4) | Costs 1 less for each Vim card played this combat. Deal 21(24) damage. |
| Un-De-Escalate | ![](small-card-images/Un-De-Escalate.png) | ![](small-card-images/Un-De-EscalatePlus.png) | Uncommon | Skill | 0 | Retain. You and ALL enemies (not and ALL enemies)lose 1 stack of all debuffs. |
| Weigh In | ![](small-card-images/WeighIn.png) | ![](small-card-images/WeighInPlus.png) | Uncommon | Skill | 1 | Innate. Apply 2 Weak and !sleuthSecondMagic! Vulnerable to ALL enemies. Exhaust. |
| Wizard's Sudoku | ![](small-card-images/WizardsSudoku.png) | ![](small-card-images/WizardsSudokuPlus.png) | Uncommon | Skill | 1 | Draw 1 card (and give it Retain this combat). It costs 0 until played. |
| Brass Tacks | ![](small-card-images/BrassTacks.png) | ![](small-card-images/BrassTacksPlus.png) | Rare | Attack | 2 | Deal 15(18) damage to ALL enemies. Discard your hand, then draw that many cards. |
| Candid Bullets | ![](small-card-images/CandidBullets.png) | ![](small-card-images/CandidBulletsPlus.png) | Rare | Power | 1(0) | Gain 3 Strength. At the end of your turn, lose 1 Imagination. |
| Candy Mech | ![](small-card-images/CandyMech.png) | ![](small-card-images/CandyMechPlus.png) | Rare | Attack | 2 | Gain 16 Block. Deal 16 damage. Lose 3(2) Imagination. |
| Candycorn Vampire | ![](small-card-images/CandycornVampire.png) | ![](small-card-images/CandycornVampirePlus.png) | Rare | Power | 1 |  Gain !sleuthSecondMagic! Dexterity. Gain 3(6) Malleable. |
| Conjure | ![](small-card-images/Conjure.png) | ![](small-card-images/ConjurePlus.png) | Rare | Attack | 1 | Choose 2(3): Deal 6 damage. Apply 2 Weak. Apply 2 Vulnerable. |
| Diabeatdown | ![](small-card-images/Diabeatdown.png) | ![](small-card-images/DiabeatdownPlus.png) | Rare | Attack | 2 | Deal 24(30) damage to the enemy with the least HP. If this kills an enemy, repeat it. |
| Gummy Zombie | ![](small-card-images/GummyZombie.png) | ![](small-card-images/GummyZombiePlus.png) | Rare | Power | 2(1) | At the end of your turn, gain 1 Temporary_HP for each card in your hand. |
| Hero Bust | ![](small-card-images/HeroBust.png) | ![](small-card-images/HeroBustPlus.png) | Rare | Skill | 3(2) | Retain. Drop: Prevent the next time you would lose HP. |
| Hit the Mattresses | ![](small-card-images/HittheMattresses.png) | ![](small-card-images/HittheMattressesPlus.png) | Rare | Attack | 2 | Deal damage equal to your combined stats. Exhaust. |
| Leverage Height | ![](small-card-images/LeverageHeight.png) | ![](small-card-images/LeverageHeightPlus.png) | Rare | Attack | 1 | Deal 12(15) damage. Discard 1(2) card(s). Draw 1(2) card(s). |
| Machinegun/Hairpin | ![](small-card-images/MachinegunHairpin.png) | ![](small-card-images/MachinegunHairpinPlus.png) | Rare | Attack | 1 | Deal 8(10) damage twice. / Gain 7(9) Block twice. Switches form whenever played. |
| Mob Rule | ![](small-card-images/MobRule.png) | ![](small-card-images/MobRulePlus.png) | Rare | Skill | 2 | ALL enemies become Stunned. Topdeck 4(3) Murals. |

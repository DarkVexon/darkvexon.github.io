...
function initGame(images) {
    ...
    var canvas = new Canvas({ id: 'main', game: game, initialScale: 2, backgroundColor: '#87835d' });
...
function initWebsocket() {
    ...
    ws.on('data',function(data) {
        ...
        if(data.type == 'server-list') {
            ...
            world = new World(game, Math.round(3.4 * Math.sqrt(Object.keys(userList).length)));

...
| ![](relics/StrikeShooter.png) | Special Power Activator | Common |  | You cannot read this out of combat. | Does many things! |
...
| ![](relics/KeyChain.png) | Key Chain | Uncommon |  | Start each combat with #b1 #yIntangible. | Surprisingly blunt! |
| ![](relics/OrbOfGreed.png) | Orb of Greed | Uncommon | Blue | At the start of each combat, #yChannel #b1 #yGolden #yπLightning. | Mmm, money! |
...
| ![](relics/TanglingVine.png) | Tangling Vine | Boss |  | Gain [E] at the start of your turn. Start each combat with #b3 #yConstricted. | Don't take this the wrong way. |

...
| ![](relics/DrawConverter.png) | Dusty Game Cartridge | Common |  | Whenever you draw a card during your turn, gain #b1 #yBlock. | It's unclear which system the game was meant for. |
...
| ![](relics/StrikeShooter.png) | Strike Shooter | Common |  | At the start of every third turn, play a πStrike at a random target. | All your sword-firing needs in one medium package! |
...
| ![](relics/DeviousBotling.png) | Devious Botling | Boss |  | Gain [E] at the start of your turn. Torments you every 3rd turn in annoying ways. Insults you on Twitter when you die. | A tiny little mini-bot whose prime directive is to mess with people. Twitter at @DBotling. |

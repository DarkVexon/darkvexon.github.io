...
| Bug Barrage | ![](small-card-images/BugBarrage.png) | ![](small-card-images/BugBarragePlus.png) | Common | Attack | 1 | Add 1 (1(2)) *Wound(s) to your hand. bronze:Cycle each Status in your hand, dealing 7 damage for each. |
...
| Blockchain | ![](small-card-images/Blockchain.png) | ![](small-card-images/BlockchainPlus.png) | Uncommon | Skill | 0 | Gain 1 bronze:Blur.  (bronze:Compile - Gain 1 bronze:Blur.) |
...
| Haunting Lick | ![](small-card-images/HauntingLick.png) | ![](small-card-images/HauntingLickPlus.png) | Common | Skill | 0 | Apply 1 Vulnerable and !SlimeboundSlimed! slimeboundmod:Goop. (Draw a card.)  Exhaust. |
